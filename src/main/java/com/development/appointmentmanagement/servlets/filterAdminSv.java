...
@WebServlet(name = "filterAdminSv", urlPatterns = {"/filterAdminSv"})

public class filterAdminSv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (appointments != null) {
            ...
            LocalDate selectedDate = LocalDate.parse(fechaString);

            if (estado) {
                appointments = controller.filterByDateStatus(selectedDate, true);
            } else {
                appointments = controller.filterByDateStatus(selectedDate, false);
            }
