   ...
   public UserJpaController() {
    ...
    boolean authenticateUser(String username, String password) {
        ...
        try {
            ...
            Query query = em.createQuery("SELECT COUNT(u) FROM User u WHERE u.username = :username AND u.password = :password");
            query.setParameter("username", username);
            query.setParameter("password", password);
            // Si la cantidad de usuarios con el nombre de usuario y contraseña es mayor que cero, el usuario es válido
